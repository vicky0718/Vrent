...
const DiscoverSection = () => {
    return (
      ...
      >
        <div className="max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3 lg:gap-12 xl:gap-16 text-center">
            {[
              {
  ...
  const DiscoverCard = ({
    ...
    <div className="px-4 py-8 shadow-lg rounded-lg bg-primary-50">
      <div className="bg-primary-700 p-2 rounded-full mb-4 h-12 w-12 mx-auto">
        <Image
          src={imageSrc}
          width={40}
          height={40}
